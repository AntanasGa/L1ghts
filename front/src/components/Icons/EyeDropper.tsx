...
export default function EyeDropper(props: IconProps) {
  const classList = [];
  if (props.classNameArr) {
    classList.push(...props.classNameArr);
  }
  return (
    <svg className={ classList.join(" ") } xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
